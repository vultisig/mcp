...
func bindAToken(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := ATokenMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
func (_AToken *ATokenCaller) REWARDSCONTROLLER(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _AToken.contract.Call(opts, &out, "REWARDS_CONTROLLER")
...
//
// Solidity: function REWARDS_CONTROLLER() view returns(address)
func (_AToken *ATokenSession) REWARDSCONTROLLER() (common.Address, error) {
	return _AToken.Contract.REWARDSCONTROLLER(&_AToken.CallOpts)
}

// REWARDSCONTROLLER is a free data retrieval call binding the contract method 0xcd086d45.
//
// Solidity: function REWARDS_CONTROLLER() view returns(address)
func (_AToken *ATokenCallerSession) REWARDSCONTROLLER() (common.Address, error) {
	return _AToken.Contract.REWARDSCONTROLLER(&_AToken.CallOpts)
}
...
func (_AToken *ATokenCaller) TREASURY(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _AToken.contract.Call(opts, &out, "TREASURY")
...
//
// Solidity: function TREASURY() view returns(address)
func (_AToken *ATokenSession) TREASURY() (common.Address, error) {
	return _AToken.Contract.TREASURY(&_AToken.CallOpts)
}

// TREASURY is a free data retrieval call binding the contract method 0x2d2c5565.
//
// Solidity: function TREASURY() view returns(address)
func (_AToken *ATokenCallerSession) TREASURY() (common.Address, error) {
	return _AToken.Contract.TREASURY(&_AToken.CallOpts)
}
...
func (_AToken *ATokenTransactor) Burn(opts *bind.TransactOpts, from common.Address, receiverOfUnderlying common.Address, amount *big.Int, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "burn", from, receiverOfUnderlying, amount, scaledAmount, index)
}

// Burn is a paid mutator transaction binding the contract method 0xb18d6afd.
//
// Solidity: function burn(address from, address receiverOfUnderlying, uint256 amount, uint256 scaledAmount, uint256 index) returns(bool)
func (_AToken *ATokenSession) Burn(from common.Address, receiverOfUnderlying common.Address, amount *big.Int, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.Burn(&_AToken.TransactOpts, from, receiverOfUnderlying, amount, scaledAmount, index)
}

// Burn is a paid mutator transaction binding the contract method 0xb18d6afd.
//
// Solidity: function burn(address from, address receiverOfUnderlying, uint256 amount, uint256 scaledAmount, uint256 index) returns(bool)
func (_AToken *ATokenTransactorSession) Burn(from common.Address, receiverOfUnderlying common.Address, amount *big.Int, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.Burn(&_AToken.TransactOpts, from, receiverOfUnderlying, amount, scaledAmount, index)
}
...
func (_AToken *ATokenTransactor) Initialize(opts *bind.TransactOpts, initializingPool common.Address, underlyingAsset common.Address, aTokenDecimals uint8, aTokenName string, aTokenSymbol string, params []byte) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "initialize", initializingPool, underlyingAsset, aTokenDecimals, aTokenName, aTokenSymbol, params)
}

// Initialize is a paid mutator transaction binding the contract method 0x7fdd585f.
//
// Solidity: function initialize(address initializingPool, address underlyingAsset, uint8 aTokenDecimals, string aTokenName, string aTokenSymbol, bytes params) returns()
func (_AToken *ATokenSession) Initialize(initializingPool common.Address, underlyingAsset common.Address, aTokenDecimals uint8, aTokenName string, aTokenSymbol string, params []byte) (*types.Transaction, error) {
	return _AToken.Contract.Initialize(&_AToken.TransactOpts, initializingPool, underlyingAsset, aTokenDecimals, aTokenName, aTokenSymbol, params)
}

// Initialize is a paid mutator transaction binding the contract method 0x7fdd585f.
//
// Solidity: function initialize(address initializingPool, address underlyingAsset, uint8 aTokenDecimals, string aTokenName, string aTokenSymbol, bytes params) returns()
func (_AToken *ATokenTransactorSession) Initialize(initializingPool common.Address, underlyingAsset common.Address, aTokenDecimals uint8, aTokenName string, aTokenSymbol string, params []byte) (*types.Transaction, error) {
	return _AToken.Contract.Initialize(&_AToken.TransactOpts, initializingPool, underlyingAsset, aTokenDecimals, aTokenName, aTokenSymbol, params)
}
...
func (_AToken *ATokenTransactor) Mint(opts *bind.TransactOpts, caller common.Address, onBehalfOf common.Address, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "mint", caller, onBehalfOf, scaledAmount, index)
}

// Mint is a paid mutator transaction binding the contract method 0xb3f1c93d.
//
// Solidity: function mint(address caller, address onBehalfOf, uint256 scaledAmount, uint256 index) returns(bool)
func (_AToken *ATokenSession) Mint(caller common.Address, onBehalfOf common.Address, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.Mint(&_AToken.TransactOpts, caller, onBehalfOf, scaledAmount, index)
}

// Mint is a paid mutator transaction binding the contract method 0xb3f1c93d.
//
// Solidity: function mint(address caller, address onBehalfOf, uint256 scaledAmount, uint256 index) returns(bool)
func (_AToken *ATokenTransactorSession) Mint(caller common.Address, onBehalfOf common.Address, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.Mint(&_AToken.TransactOpts, caller, onBehalfOf, scaledAmount, index)
}
...
func (_AToken *ATokenTransactor) MintToTreasury(opts *bind.TransactOpts, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "mintToTreasury", scaledAmount, index)
}

// MintToTreasury is a paid mutator transaction binding the contract method 0x7df5bd3b.
//
// Solidity: function mintToTreasury(uint256 scaledAmount, uint256 index) returns()
func (_AToken *ATokenSession) MintToTreasury(scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.MintToTreasury(&_AToken.TransactOpts, scaledAmount, index)
}

// MintToTreasury is a paid mutator transaction binding the contract method 0x7df5bd3b.
//
// Solidity: function mintToTreasury(uint256 scaledAmount, uint256 index) returns()
func (_AToken *ATokenTransactorSession) MintToTreasury(scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.MintToTreasury(&_AToken.TransactOpts, scaledAmount, index)
}
...
// RenounceAllowance is a paid mutator transaction binding the contract method 0xaf5f243b.
//
// Solidity: function renounceAllowance(address owner) returns()
func (_AToken *ATokenTransactor) RenounceAllowance(opts *bind.TransactOpts, owner common.Address) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "renounceAllowance", owner)
}

// RenounceAllowance is a paid mutator transaction binding the contract method 0xaf5f243b.
//
// Solidity: function renounceAllowance(address owner) returns()
func (_AToken *ATokenSession) RenounceAllowance(owner common.Address) (*types.Transaction, error) {
	return _AToken.Contract.RenounceAllowance(&_AToken.TransactOpts, owner)
}

// RenounceAllowance is a paid mutator transaction binding the contract method 0xaf5f243b.
//
// Solidity: function renounceAllowance(address owner) returns()
func (_AToken *ATokenTransactorSession) RenounceAllowance(owner common.Address) (*types.Transaction, error) {
	return _AToken.Contract.RenounceAllowance(&_AToken.TransactOpts, owner)
}
...
func (_AToken *ATokenTransactor) TransferOnLiquidation(opts *bind.TransactOpts, from common.Address, to common.Address, amount *big.Int, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "transferOnLiquidation", from, to, amount, scaledAmount, index)
}

// TransferOnLiquidation is a paid mutator transaction binding the contract method 0x353b7b9a.
//
// Solidity: function transferOnLiquidation(address from, address to, uint256 amount, uint256 scaledAmount, uint256 index) returns()
func (_AToken *ATokenSession) TransferOnLiquidation(from common.Address, to common.Address, amount *big.Int, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.TransferOnLiquidation(&_AToken.TransactOpts, from, to, amount, scaledAmount, index)
}

// TransferOnLiquidation is a paid mutator transaction binding the contract method 0x353b7b9a.
//
// Solidity: function transferOnLiquidation(address from, address to, uint256 amount, uint256 scaledAmount, uint256 index) returns()
func (_AToken *ATokenTransactorSession) TransferOnLiquidation(from common.Address, to common.Address, amount *big.Int, scaledAmount *big.Int, index *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.TransferOnLiquidation(&_AToken.TransactOpts, from, to, amount, scaledAmount, index)
}
